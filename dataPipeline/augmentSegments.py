...
def timestampSegments(segments, timestamps):
...
def addVideoToSegments(video_name, timestamped_segments):
    for segment_dict in timestamped_segments:
        segment_dict['video_name'] = video_name
    return timestamped_segments
